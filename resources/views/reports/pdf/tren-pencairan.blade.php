...
<head>
    <meta charset="utf-8">
    <title>Laporan Tren Pencairan Dana Bulanan</title>
    <style>
...
<body>
    ...
    <div class="report-title">LAPORAN TREN PENCAIRAN DANA BULANAN</div>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th class="text-right">Total Pencairan (Rp)</th>
            </tr>
        </thead>
        <tbody>
        ...
        <tfoot>
            <tr>
                ...
                <th class="text-right" style="font-size: 14px;">{{ number_format($grandTotal, 0, ',', '.') }}</th>
            </tr>
        </tfoot>
    </table>
