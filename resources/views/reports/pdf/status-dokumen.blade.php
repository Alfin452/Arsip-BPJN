...
<head>
    <meta charset="utf-8">
    <title>Laporan Status Verifikasi Dokumen SPM</title>
    <style>
...
<body>
    ...
    <div class="report-title">Laporan Status Verifikasi Dokumen SPM</div>
    <div class="report-subtitle">Tahun Anggaran {{ $tahun }}</div>

    <table class="data-table">
        <thead>
            <tr>
                <th class="text-left">Status Verifikasi</th>
...
@php $grandTotal = 0; @endphp
            ...
            <tr>
                <td class="text-left"><strong>{{ $row->status }}</strong></td>
