...
<head>
    <meta charset="utf-8">
    <title>Laporan Tagihan Outstanding per Satker</title>
    <style>
...
<body>
    ...
    <div class="report-title">Laporan Tagihan Outstanding per Satker</div>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th class="text-right">Total Tagihan Belum Cair (Rp)</th>
            </tr>
        </thead>
        <tbody>
@php $grandTotal = 0; @endphp
            ...
            @empty
            <tr>
                <td colspan="2" class="text-center">Semua tagihan sudah cair (tidak ada outstanding) untuk tahun {{ $tahun }}.</td>
            </tr>
            @endforelse
        </tbody>
        <tfoot>
