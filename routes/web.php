...
Route::middleware('auth')->group(function () {
    ...
    // Laporan Analitik (Semua role bisa akses)
    ...
    // Data Operasional (Semua role bisa akses, tapi 'atasan' dibatasi di Controller)
...
// Hanya Admin (Master Data, User, Activity Log)
